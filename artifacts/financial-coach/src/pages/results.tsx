        ...
        <Tabs defaultValue="budget" className="w-full">
          ...
          <TabsContent value="debt" className="space-y-6 mt-6">
            <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-6">
              {!hasDebt ? (
                <motion.div variants={itemVariants}>
                  <Card className="glass-card bg-green-500/5 border-green-500/20 text-center py-16">
                    ...
                    <Card className="glass-card">
                      ...
                      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {debtReduction.avalanche && (
                          <div className="border rounded-xl p-5 bg-muted/20 relative overflow-hidden backdrop-blur-md border-border/50">
                            ...
                            <div className="space-y-3 mb-6 bg-background/50 backdrop-blur-sm p-4 rounded-lg border">
